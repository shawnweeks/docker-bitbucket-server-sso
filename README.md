# Bitbucket Crowd SSO
This is taken from Atlassians Bitbucket Docker repo and customized to support our need for SSO through a custom login application.
