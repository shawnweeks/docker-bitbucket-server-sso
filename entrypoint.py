...
props = {
    ...
    "server.key-store":env.get("ATL_TOMCAT_KEYSTORE",""),
    "server.key-store-password":env.get("ATL_TOMCAT_KEYSTORE_PASSWORD",""),
    "server.ssl.key-password":env.get("ATL_TOMCAT_KEYPASSWORD",""),
